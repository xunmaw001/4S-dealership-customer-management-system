<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="门店账号" prop="mendianzhanghao">
          <el-input v-model="ruleForm.mendianzhanghao" 
              placeholder="门店账号" clearable  :readonly="ro.mendianzhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="门店账号" prop="mendianzhanghao">
              <el-input v-model="ruleForm.mendianzhanghao" 
                placeholder="门店账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="门店名称" prop="mendianmingcheng">
              <el-input v-model="ruleForm.mendianmingcheng" 
                placeholder="门店名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="汽车名称" prop="qichemingcheng">
          <el-input v-model="ruleForm.qichemingcheng" 
              placeholder="汽车名称" clearable  :readonly="ro.qichemingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="汽车名称" prop="qichemingcheng">
              <el-input v-model="ruleForm.qichemingcheng" 
                placeholder="汽车名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="汽车分类" prop="qichefenlei">
          <el-select v-model="ruleForm.qichefenlei" placeholder="请选择汽车分类">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="汽车分类" prop="qichefenlei">
  ...
  data() {
	...
	userid : false,
            ...
            ruleForm: {
                  ...
                  qichefenlei: [
                            { required: true, message: '汽车分类不能为空', trigger: 'blur' },
                                    	                                                              ],
                  qichepinpai: [
  ...
  methods: {
    ...
    init(id,type) {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
                      		if(json.mendianzhanghao!=''&&json.mendianzhanghao){
              		this.ruleForm.mendianzhanghao = json.mendianzhanghao
		}
                                  		if(json.mendianmingcheng!=''&&json.mendianmingcheng){
              		this.ruleForm.mendianmingcheng = json.mendianmingcheng
		}
                                                                                                                                                                                                                                                                                                                                                                        } else {
	...
	this.ruleForm.qichexiangqing = this.ruleForm.qichexiangqing.replace(reg,'../../../ssmli99j/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `chezhan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.chezhanCrossAddOrUpdateFlag = false;
                  this.parent.search();
