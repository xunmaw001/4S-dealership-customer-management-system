  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 0.26);borderRadius:10px">
        <h1 class="h1" style="color:rgba(255, 255, 255, 1);fontSize:28px;">4S店客户管理系统小程序注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="邮箱" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.youxiang" autocomplete="off" placeholder="邮箱" type="text" />
																																										...
																																										<!-- <div v-if="tableName=='mendian'" class="input-group">
			   <div class="label">门店账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.mendianzhanghao" class="input" type="text" placeholder="门店账号">
			   </div>
			 </div> -->
			<el-form-item label="门店账号" class="input" v-if="tableName=='mendian'">
			  <el-input v-model="ruleForm.mendianzhanghao" autocomplete="off" placeholder="门店账号" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='mendian'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='mendian'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='mendian'" class="input-group">
			...
			<el-form-item label="门店名称" class="input" v-if="tableName=='mendian'">
			  <el-input v-model="ruleForm.mendianmingcheng" autocomplete="off" placeholder="门店名称" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='mendian'" class="input-group">
			...
			<el-form-item label="负责人" class="input" v-if="tableName=='mendian'">
			...
			<el-form-item label="手机" class="input" v-if="tableName=='mendian'">
			  <el-input v-model="ruleForm.shouji" autocomplete="off" placeholder="手机" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='mendian'" class="input-group">
			   <div class="label">邮箱</div>
			...
			<el-form-item label="邮箱" class="input" v-if="tableName=='mendian'">
			  <el-input v-model="ruleForm.youxiang" autocomplete="off" placeholder="邮箱" type="text" />
			</el-form-item>
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://codegen.caihongy.cn/20201124/cbd8317166c749138539adbb367a0313.jpg");
		height: 100vh;
