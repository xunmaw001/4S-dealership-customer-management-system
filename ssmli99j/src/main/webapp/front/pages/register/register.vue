<template>
	<view class="content">
		...
		<view v-if="tableName=='yonghu'" class="uni-form-item uni-column">
			<input :style='{"borderColor":"rgba(121, 186, 121, 1)","backgroundColor":"#fff","borderRadius":"16rpx","color":"#333","textAlign":"left","borderWidth":"4rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}' v-model="ruleForm.youxiang" type="text" class="uni-input" name="" placeholder="邮箱" />
		</view>
		<view v-if="tableName=='mendian'" class="uni-form-item uni-column">
			<input :style='{"borderColor":"rgba(121, 186, 121, 1)","backgroundColor":"#fff","borderRadius":"16rpx","color":"#333","textAlign":"left","borderWidth":"4rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}' v-model="ruleForm.mendianzhanghao" type="text" class="uni-input" name="" placeholder="门店账号" />
		</view>
		<view v-if="tableName=='mendian'" class="uni-form-item uni-column">
			<input :style='{"borderColor":"rgba(121, 186, 121, 1)","backgroundColor":"#fff","borderRadius":"16rpx","color":"#333","textAlign":"left","borderWidth":"4rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}' v-model="ruleForm.mima" type="text" class="uni-input" name="" placeholder="密码" />
		</view>
		<view v-if="tableName=='mendian'" class="uni-form-item uni-column">
			<input :style='{"borderColor":"rgba(121, 186, 121, 1)","backgroundColor":"#fff","borderRadius":"16rpx","color":"#333","textAlign":"left","borderWidth":"4rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}' v-model="ruleForm.mendianmingcheng" type="text" class="uni-input" name="" placeholder="门店名称" />
		</view>
		<view v-if="tableName=='mendian'" class="uni-form-item uni-column">
			<input :style='{"borderColor":"rgba(121, 186, 121, 1)","backgroundColor":"#fff","borderRadius":"16rpx","color":"#333","textAlign":"left","borderWidth":"4rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}' v-model="ruleForm.fuzeren" type="text" class="uni-input" name="" placeholder="负责人" />
		</view>
		<view v-if="tableName=='mendian'" class="uni-form-item uni-column">
			<input :style='{"borderColor":"rgba(121, 186, 121, 1)","backgroundColor":"#fff","borderRadius":"16rpx","color":"#333","textAlign":"left","borderWidth":"4rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}' v-model="ruleForm.shouji" type="text" class="uni-input" name="" placeholder="手机" />
		</view>
