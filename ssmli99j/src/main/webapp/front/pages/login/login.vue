<template>
	<view class="content">
		<view class="logo">
			<image :style='{"boxShadow":"0 0 0px #59f43e","borderColor":"rgba(0, 204, 0, 1)","borderRadius":"40rpx","borderWidth":"2rpx","width":"160rpx","borderStyle":"solid","url":"http://codegen.caihongy.cn/20210103/77a3c7239d224ba09aed4120a29fb40c.jpg","isShow":true,"height":"160rpx"}' src='http://codegen.caihongy.cn/20210103/77a3c7239d224ba09aed4120a29fb40c.jpg' mode="aspectFill"></image>
		</view>
		...
		<view class="links">
            			            <view class="link-highlight" @tap="onRegisterTap('yonghu')" :style='{"color":"rgba(0, 204, 0, 1)","fontSize":"26rpx"}'>注册用户</view>
            <view>|</view>
                        			            <view class="link-highlight" @tap="onRegisterTap('mendian')" :style='{"color":"rgba(0, 204, 0, 1)","fontSize":"26rpx"}'>注册门店</view>
            <view>|</view>
...
<style lang="scss" scoped>
	...
	.content:after {
		...
		bottom: 0;
		content: '';
				background-image: url(http://codegen.caihongy.cn/20201207/2375faee8a884b19b37041784a37303d.jpg);
